...
public enum Radius {
    ...
    /// Chat bubbles read as softer than cards.
...
public enum TypeScale {
    ...
    /// Agent output is frequently code — a mono face for fenced content.
    public static let code = Font.system(size: 13, design: .monospaced)
}
