...
//  (design-system/templates/shared/color-system.ts) and the my-designer
//  swiftui scaffold.
//
...
//
//  Ported to iOS: color decomposition bridges through UIColor instead of
//  NSColor. The math is byte-identical to the macOS template.
// ============================================================================
...
/// Decomposes a color into hue/saturation/brightness.
///
/// The platform bridge is the only thing that differs between iOS and macOS —
/// everything downstream is pure math on these three numbers.
...
/// Picks black or white for maximum contrast against `bg` (WCAG ratio).
